...
export default class TokenHarness extends LitElement {
  ...
  render() {
    let content = html`
      ...
      >
        <action-card
          title="SimpleToken - Instance"
          description="Create your own Tenant"
          action="SimpleTokenInstance"
          method="post"
          fields="signer"
        >
        ...
        <action-card
          title="SimpleToken - Get Client Tenants"
          description="Get the client tenants for this account"
          action="SimpleTokenGetClientTenants"
          method="get"
          fields="account"
        >
        ...
        <action-card
          title="SimpleToken - Give Minter"
          description="Give a SimpleToken minter"
          action="SimpleTokenGiveMinter"
          method="post"
        ...
        <action-card
          title="SimpleToken - Mint Tokens"
          description="Mint Tokens"
          action="SimpleTokenMintFT"
          method="post"
          fields="tenantOwner signer recipient amount"
        >
          <account-widget field="tenantOwner" label="Tenant Owner">
          </account-widget>
          <account-widget field="signer" label="FTMinter"> </account-widget>
          <account-widget field="recipient" label="Recipient"> </account-widget>
          <text-widget
            field="amount"
        ...
        <action-card
          title="SimpleToken - Transfer Tokens"
          description="Transfer Tokens"
          action="SimpleTokenTransferFT"
          method="post"
          fields="tenantOwner signer recipient amount"
        >
          <account-widget field="tenantOwner" label="Tenant Owner">
        ...
        <action-card
          title="SimpleToken - Get Balance"
          description="Get Balance"
          action="SimpleTokenGetBalance"
          method="get"
